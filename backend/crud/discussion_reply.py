...
class DiscussionReplyCrudManager:
    async def create(self, topic_id, publisher, newDiscussionReply: DiscussionReplySchema.DiscussionReplyCreate, db_session: AsyncSession):
        newDiscussionReply_dict = newDiscussionReply.model_dump()
        discussion_reply = DiscussionReplyModel(**newDiscussionReply_dict, topic_id=topic_id, publisher=publisher)
